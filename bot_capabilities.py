...
3. BOT_LIMITATIONS: What Ranviar CANNOT do (no prescribing, medical scope only, 70MB limit, 60 docs max).
...
BOT_CAPABILITIES: Dict[str, dict] = {
    ...
    "document_vault": {
        ...
        "summary": (
            "Upload lecture slides, departmental handouts, and notes up to 70MB. Even scanned documents are read with AI OCR! "
        ...
        "prompt_instruction": (
            "You FULLY accept and process PDF, Word, and PowerPoint documents up to 70MB (including scanned PDFs with AI OCR). "
...
BOT_LIMITATIONS = [
    ...
    },
    {
        ...
        "rule": "Document uploads are supported up to 70MB per file (PDF, Word, PPT), and each student's personal vault stores up to 60 documents."
    },
    {
...
def render_limitations_card(student_name: str = "Doc") -> str:
    ...
    return (
        ...
        "• 🚫 *File Limits*: Uploads capped at 70MB per file and 60 documents per vault.\n"
