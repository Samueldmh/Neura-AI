      ...
      <header class="border-b border-obsidian-border bg-[#0B0C0E]/90 backdrop-blur-xl sticky top-0 z-40 px-4 sm:px-6 py-3.5 flex flex-col gap-3">
        <div class="flex items-center justify-between">
          ...
          <div class="hidden lg:flex items-center gap-3">
            <span class="text-xs font-bold text-slate-400 uppercase tracking-wider" id="current-view-title"><i class="fa-solid fa-users text-lime-accent mr-1.5"></i> Registered Students & Wallets Directory</span>
          </div>
...
Type your announcement on the left to see how it renders live on students' WhatsApp screens in real-time.
  ...
  <script>
    ...
    const VIEW_TITLES = {
      'students': '<i class="fa-solid fa-users text-lime-accent mr-1.5"></i> Registered Students & Wallets Directory',
    ...
    function initLineSidebar({
      items = [
        { label: 'Students & Wallets', key: 'students' },
